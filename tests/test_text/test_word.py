...
@pytest.mark.parametrize('string,p,exp', [
    ('', 0.0, ''),
    ('', 1.0, ''),
    ('politician persuades dramatic rhythms', 0.0, 'politician persuades dramatic rhythms'),
    ('politician persuades dramatic rhythms', 1.0, 'politican pursuades dramtic rythyms')
])
